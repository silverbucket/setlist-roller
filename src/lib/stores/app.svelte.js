...
export function createAppStore(repo) {
    ...
    // Keep a single app context API; forwarding accessors preserve rune reactivity.
    const dataIo = createDataIoStore(repo, {
        state: {
        ...
        storageKey, sessionGuard, withSync,
